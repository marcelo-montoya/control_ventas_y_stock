...
class CostumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create costumer" do
    assert_difference("Costumer.count") do
      post costumers_url, params: { costumer: { email: @costumer.email, nombre: @costumer.nombre } }
    end
  ...
  test "should update costumer" do
    patch costumer_url(@costumer), params: { costumer: { email: @costumer.email, nombre: @costumer.nombre } }
